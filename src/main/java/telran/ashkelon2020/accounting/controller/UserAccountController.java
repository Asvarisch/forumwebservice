...
public class UserAccountController {
	...
	public RolesResponseDto addRole(@PathVariable String login, @PathVariable String role, @RequestHeader("Authorization") String token) {
		String user = securityService.getLogin(token);
	...
	public RolesResponseDto removeRole(@PathVariable String login, @PathVariable String role, @RequestHeader("Authorization") String token) {
		String user = securityService.getLogin(token);
		boolean isAdmin = securityService.isAdmin(user);
		if (!isAdmin) {
			throw new ForbiddenException();
